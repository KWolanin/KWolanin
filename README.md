...
I got into an internship program that prepared me for a **Full Stack Developer** role. There, I learned **Vue.js** (both version 2 and 3), improved my skills in **JavaScript and TypeScript**, and gained the ability to create full web applications. I spent almost three years in this role, growing my skills, and I’ve come to enjoy frontend development just as much as backend. I’m proud that I can take a feature from idea to completion on my own. 💡 Both backend and frontend are areas I feel comfortable.
...
- [Lerni.app](https://github.com/KWolanin/lerni.app) – a minimalist, customizable daily learning dashboard with a todo list, pomodoro timer, and focus-friendly music and other widgets to help with focus and organization 📚. Stack: Vue.js (code), Firebase (NO-SQL database), work in progress.
...
I'm also interested in history — especially the history of Prussia. I find it fascinating how it evolved: from the Teutonic Order invited to fight the Baltic Prussians, to a Polish fief, and eventually into a militaristic state built together with Brandenburg. I also really enjoy learning about Lithuanian culture and language. 📚
